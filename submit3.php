...
<html lang="en">
  <head>
    <title>Hostel Finder</title>    <!-- Required meta tags -->
    <meta charset="utf-8">
  ...
  <body class="text-white">
    ...
    <nav class="navbar navbar-toggleable-md navbar-inverse fixed-top bg-inverse">
      ...
      <a class="navbar-brand" href="#"><h1>Hostel Finder</h1></a>
...
<?php
  ...
  $sql = "select Room_capacity,Fees,H_name,Type,Owner_name,Phone_number,Email_ID,Capacity,Total_no_of_rooms,no_of_meals,Mess_fees,Mess_capacity
