<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-toggleable-md navbar-inverse fixed-top bg-inverse">
      ...
      <a class="navbar-brand" href="#"><h1><span>H</span>ostel Finder</h1></a>
...
Hostel,
Phone_number,
Capacity) values('".$_POST["name"]."','".$_POST["pincode"]."','".$_POST["type"]."','".$_POST["hostel_pg"]."','".$_POST["owner_phone"]."','".$_POST["capacity"]."');";
